-- Migration generated from data_huerto_backend.sql

-- NOTE: This migration assumes the database/schema already exists and
-- the connection is pointed to the target database. Removed DROP/CREATE/USE
-- statements so Flyway can run the migration safely against the configured DB.
